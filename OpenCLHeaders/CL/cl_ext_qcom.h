...
typedef cl_mem
(CL_API_CALL *clCreateBufferFromImageQCOM_fn)(cl_mem       image,
                                              cl_mem_flags flags,
                                              cl_int      *errcode_ret);
...
typedef cl_int
(CL_API_CALL *clSetPerfHintQCOM_fn)(cl_context    context,
                                    cl_perf_hint  perf_hint);
...
#ifndef CL_MEM_ANDROID_AHARDWAREBUFFER_HOST_PTR_QCOM
...
#endif    //#ifndef CL_MEM_ANDROID_AHARDWAREBUFFER_HOST_PTR_QCOM
...
(CL_API_CALL *clNewRecordingQCOM_fn)(cl_command_queue, cl_int *);
typedef cl_int
(CL_API_CALL *clEndRecordingQCOM_fn)(cl_recording_qcom);
typedef cl_int
(CL_API_CALL *clReleaseRecordingQCOM_fn)(cl_recording_qcom);
typedef cl_int
(CL_API_CALL *clRetainRecordingQCOM_fn)(cl_recording_qcom);
...
typedef cl_int
(CL_API_CALL *clEnqueueRecordingQCOM_fn)(cl_command_queue    /** command_queue */,
                                         cl_recording_qcom   /** recording */,
...
typedef cl_int
(CL_API_CALL *clEnqueueRecordingSVMQCOM_fn)(cl_command_queue    /** command_queue */,
                                            cl_recording_qcom   /** recording */,
...
#define CL_IMAGE_HEIGHT_ALIGNMENT_QCOM            0x411A
...
typedef cl_int
(CL_API_CALL *clQueryImageInfoQCOM_fn)(cl_device_id device,
                                       cl_mem_flags flags,
                                       const cl_image_format * image_format,
                                       const cl_image_desc * image_desc,
                                       cl_extended_image_info_qcom param_name,
...
/**************************
 * D3D11 NT handle import
 **************************/
#define CL_MEM_D3D11_NT_HANDLE_QCOM                                         0x40AA

/**************************
 * cl_qcom_large_buffer *
 **************************/

#define CL_LARGE_BUFFER_QCOM                                            0x41A6
